...
$order = @('01_schema.sql', '02_seed_settings.sql',
           ...
           '20_pm_notify.sql', '21_pm_payment.sql', '22_admin_tools.sql', '23_pm_pkg_merge.sql', '24_ui_feedback.sql', '25_pm_tender.sql', '26_alr_project.sql', '27_liquidation.sql', '28_liquidation_batch.sql', '29_liquidation_bid.sql', '30_acc_reconcile.sql', '31_asset_ops.sql', '32_price_db.sql', '33_meetings.sql')
